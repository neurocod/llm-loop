// Vendored: CTRE (compile-time regular expressions) by Hana Dusikova.
//   https://github.com/hanickadot/compile-time-regular-expressions
//   tag v3.11.0, commit 4ab18abfd88ccfc867734bf5d31b13285854577e
//   file single-header/ctre.hpp, byte-for-byte below this comment
// License: Apache-2.0 WITH LLVM-exception; the full text is the comment that
// opens the file below.
//
// Vendored rather than fetched because the gate must build offline, from a
// plugin checkout. To update: replace everything below this comment with the
// same file from a newer tag, fix the tag and commit above, rebuild and run
// cpp/parity_check.py.
